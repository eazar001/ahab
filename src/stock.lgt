...
:- object(stock,
    ...
    scores(Score, ValueScore, GrowthScore) :-
        ...
        logtalk::print_message(comment, stock, pre_score_summary_header),
        logtalk::print_message(comment, stock, value_score(untranslated, ValueScore0)),
        logtalk::print_message(comment, stock, growth_score(untranslated, GrowthScore0)),
